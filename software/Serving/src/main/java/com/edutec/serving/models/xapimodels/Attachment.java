...
import com.edutec.serving.models.xapimodels.json.JSONBase;
...
public class Attachment extends JSONBase {
    ...
    public Attachment(JsonNode jsonNode) throws URISyntaxException, IOException, NoSuchAlgorithmException {
        this(jsonNode, null);
    }

    public Attachment(JsonNode jsonNode, byte[] content) throws URISyntaxException, IOException, NoSuchAlgorithmException {
