...
@EnableKafkaStreams
public class MoodleForumCdcUnpackPipeTests {
    private static final String INPUT_TOPIC = "__.goethe-universitaet-frankfurt.db.moodle.mdl_forum";
    private static final String STORENAME = "__.goethe-universitaet-frankfurt.db.moodle.mdl_forum";
    @Mock
    ...
    public void setup() throws Exception {
        ...
        Mockito.when(topicsProvider.getMoodle_forum_source()).thenReturn(inputTopic);
        Mockito.when(storeNameProvider.getMdl_forum_source_unpacked_store()).thenReturn(STORENAME);
...
//        final CdcWrapper cdcWrapper = CdcWrapper.AFTER_MDL_USER();
...
//        final CdcWrapper cdcWrapper = CdcWrapper.AFTER_MDL_USER();
//        final CdcWrapper deleteWrapper = CdcWrapper.BEFORE_MDL_USER();
//        testDriver.pipeInput(userRecordFactory.create(INPUT_TOPIC, cdcWrapper));
