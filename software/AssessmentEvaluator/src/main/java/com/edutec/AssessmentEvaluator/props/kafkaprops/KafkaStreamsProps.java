...
public class KafkaStreamsProps {
    ...
    public KafkaStreamsConfiguration kStreamsConfigs() {
        ...
        props.put(StreamsConfig.APPLICATION_ID_CONFIG, "assessment-evaluator");
...
//        props.put(StreamsConfig.DEFAULT_VALUE_SERDE_CLASS_CONFIG, Serdes.String());
        ...
        props.put(StreamsConfig.DEFAULT_TIMESTAMP_EXTRACTOR_CLASS_CONFIG, DefaultTimestampExtractor.class.getName());
